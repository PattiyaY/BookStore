...
public class ShoppingCartPage extends JFrame {
	...
	public ShoppingCartPage(Customer customer) {
		...
		labelSearch.setFont(new Font("Avenir", Font.PLAIN, 18));
		...
		table.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				if ((column == 0 || column == 1) && row >= 0) {
					Book book = new Book();
					bookSelected = table.getModel().getValueAt(row, 0).toString();
					book.searchBooks(bookSelected);

					textPane.setText("<html><body style='font-family: Avenir; font-size: 14px;'><div align='center'><b>"
							+ book.getTitle() + "</b></div><br> Author: " + book.getAuthor() + "<br><br> ISBN: "
							+ book.getISBN() + "<br><br> Edition: " + book.getEdition() + "<br><br> Description: "
							+ book.getDescribe() + "<br><br> Genre: " + book.getGenre() + "<br><br> Price: "
							+ book.getPrice() + "</html>");
				}
			}
		});
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
							...
							.addGap(22)
							.addComponent(textSearch, GroupLayout.PREFERRED_SIZE, 235, GroupLayout.PREFERRED_SIZE))
						.addComponent(scrollPane, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 557, GroupLayout.PREFERRED_SIZE))
					.addGap(18)
