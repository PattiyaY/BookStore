...
public class Payment extends JFrame {
	...
	public Payment(Customer customer) {
		...
		lblNewLabel.setBounds(391, 151, 131, 28);
		...
		lblYourRewardPoint.setBounds(540, 151, 262, 28);
		...
		JLabel lblNewLabel_1_1 = new JLabel("**Don't have no reward points type 0");
		lblNewLabel_1_1.setFont(new Font("Avenir", Font.PLAIN, 13));
		lblNewLabel_1_1.setBounds(392, 568, 250, 16);
